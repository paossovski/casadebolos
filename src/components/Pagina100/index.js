...
export const Pagina100 = () => {
  return(
    <div className='Pagina Pagina-Container Margens'>
      <div className='Container-100'>
        <p className='Texto T-100'>
          <span className='P-100'>É cobrado taxa de entrega?</span><br/><br/>
        ...
        <p className='Texto T-100'>
          <span className='P-100'>Moro próximo a loja, mesmo assim cobram taxa de entrega?</span><br/><br/>Sim, é cobrado taxa de entrega devido ao deslocamento do motoboy – é cobrado por bairro e é o valor tabelado por nossos prestadores de serviços. Se preferir, pode retirar na loja, sem problemas. Deixamos reservado o bolinho de sua preferência para o horário que preferir.
        </p><br/><br/>
        <p className='Texto T-100'>
          <span className='P-100'>Percebi que tem concorrentes que entregam grátis</span><br/><br/>Sugerimos uma comparação de qualidade, tamanho e peso do produto, as vezes quem não cobra a taxa de entrega, é porque está agregado ao valor do bolo e esta pratica certamente não terá longevidade ou seja jogamos transparente com fornecedores e clientes para que tenham conhecimento e entendimento do porque o valor é cobrado.
        </p><br/><br/>
        <p className='Texto T-100'>
          <span className='P-100'>Achei muito caro a entrega. Quando peço via ifood é mais em conta.</span><br/><br/>Os aplicativos lhe oferecem os locais mais próximos da sua casa, por isso a percepção, mas garantimos que nossos preços de entrega são exaustivamente negociados com os entregadores, mas não os exploramos, praticamos aquilo que é justo, igualmente a qualidade de nossos produtos e preços e pedimos para você comparar, no final o nosso é sempre mais em conta e certamente muito mais saboroso, natural e fresquinho.
        </p><br/><br/>
        <p className='Texto T-100'>
          <span className='P-100'>Como funciona a entrega?</span><br/><br/>
