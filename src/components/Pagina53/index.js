...
export const Pagina53 = () => {
  return(
    <div className='Pagina Pagina-Container Margens'>
      <div className='Container-53'>
        <p className='Texto T-53'>
          cozinha, devido a o alto consumo de produtos gordurosos (ex: oléo de soja e margarina) o risco de entupimento na caixa de gordura é muito grande, jogando água quente todos os dias, evitamos esse entupimento. Por isso essa prática é uma obrigação.
        </p><br/>
        <p className='Texto T-53'>
        ...
        <p>
          <b className='P-53'>Curitiba:</b> 021<br/>
          <b className='P-53'>Novo Mundo:</b> 021
        </p><br/><br/>
        <p className='Texto'>
