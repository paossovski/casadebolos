...
export const Pagina105 = () => {
  return(
    <div className='Pagina Pagina-Container Margens'>
      <div className='Container-105'>
        <p className='Texto T-105'>
        <b className='P-105'>Posso realizar compras e enviar para outro lugar, que eu não esteja lá para receber?</b><br/><br/>
        ...
        <p className='Texto T-105'>
          ...
          <span className='C-105'>SUPORTE AO CLIENTE.</span>
        </p><br/><br/>
        <p className='Texto T=105'>
