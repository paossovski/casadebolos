...
import Bolos06 from '../../images/bolos_06.jpg';
import Bolos07 from '../../images/bolos_07.jpg';
import { Numeracao } from '../Numeracao';

export const Pagina11 = () => {
  return(
    <div className='Pagina Pagina-Container Margens'>
      <div className='P11'>
        <div className='Texto Texto-P11'>
        ...
        <div className='Container-Img-P11'>
          <div className='P11'>
            <img className='P11-Img' src={Bolos06} alt="" />
          </div>
          <div className='P11'>
            <img className='P11-Img' src={Bolos07} alt="" />
          </div>
        </div>
      </div>
