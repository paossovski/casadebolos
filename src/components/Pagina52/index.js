...
import Bolos54 from '../../images/bolos_54.jpg';
  ...
  return(
    <div className='Pagina Pagina-Container Margens'>
      <div className='Container-52'>
        ...
        <img className='Img-52' src={Bolos54} alt="" /><br/><br/>
        <p className='Texto T-52'>
        ...
        <p className='Texto T-52'>
          <b>ÁGUA QUENTE NA PIA:</b>  Todos os dias após a finalização da  louça, a pessoa responsável pela limpeza, deve jogar uma panela de água quente nos ralos das pias da  
        </p>
      </div>
